...
},{"./binary":1,"./marquee":4,"./rand-color":5,"./random-font-size":6}],4:[function(require,module,exports){
...
$(() => {
    $(".randcol").each((i, el) => {
        $(el).css("color", randomColor({luminosity: 'bright'}));
    });
});

},{"randomcolor":7}],6:[function(require,module,exports){
...
},{"./htmlsplit":2}],7:[function(require,module,exports){
